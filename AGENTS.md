...
- **Write clearly.** Use `write-readably` for new durable reader-facing
  artifacts and `edit-for-readability` for existing prose rewrites. Apply the
  same readability standard inline to short conversational updates.
